...
headline: "Following Customs"
description: "A grid assumes the designer controls the final rendering, when in practice the user does. Through their personal font size, zoom level, and the language they read in."
tags:
  - "CSS"
  - "layout"
  - "responsive"
...
Working with the browser instead of against it is the through-line from this decision to how I think about layout everywhere.

...
### Give each line its own branded app instead of one app with a line picker

| Reasoning | Alternatives |
| --- | --- |
| Riders take the same line every day. Saving the one you ride means the choice is already made by the time you open it, and the page arrives branded like the signage in the station you are standing in. | A single app with in-app line selection |

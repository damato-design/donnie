...
description: "An educational reference that helps designers and developers build resilient, responsive layouts by working with the medium of the web."
metric:
  value: 2021
role: "Creator"
year: 2021
...
[Gridless Design](https://gridless.design) makes the case that the web supplies structure and order on its own, not through a fixed visual grid. It walks from the history of the grid through guidance for designers and concrete techniques for developers.
...
- **Reach:** Cited by [Brad Frost](https://bradfrost.com/blog/post/layout-grid-in-design-systems/), [Christine Vallaure](https://uxdesign.cc/why-ui-designers-should-understand-flexbox-and-css-grid-e236a9dec37a), and [Figma's design systems guide](https://www.figma.com/blog/design-systems-102-how-to-build-your-design-system/)

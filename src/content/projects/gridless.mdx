...
description: "An educational reference that helps designers and developers build resilient, responsive layouts by working with the medium of the web instead of imposing a print-style grid, cited by Brad Frost, Christine Vallaure, and Figma."
metric:
  value: 2021
role: "Creator"
year: 2021

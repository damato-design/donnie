...
description: "A design systems technique that curbs token bloat: instead of minting a new token for every expressive change, it rewires existing semantic tokens within a scope."
metric:
  value: 2023

...
description: "A design systems technique that curbs token bloat: instead of minting a new token for every expressive change, it rewires existing semantic tokens within a scope, re-pointing a style value at a generic UI concept inside a boxed part of the experience."
metric:
  value: 2023
